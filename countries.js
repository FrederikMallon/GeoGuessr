// Liste aller Staaten (Deutsch, alphabetisch sortiert) für das Land-Dropdown.
// Bewusst als eigene Datei, damit sie bei Bedarf leicht ergänzt werden kann
// (z.B. um GeoGuessr-Sondergebiete wie "Réunion" oder "Guernsey").
const COUNTRIES = [
  ...
  "Jordanien","Kambodscha","Kamerun","Kanada","Kap Verde",
  "Kasachstan","Katar","Kenia","Kirgisistan","Kiribati","Kolumbien",
  "Komoren","Kongo (Demokratische Republik)","Kongo (Republik)",
  "Kosovo","Kroatien","Kuba","Kuwait","Laos","Lesotho","Lettland",
  "Libanon","Liberia","Libyen","Liechtenstein","Litauen",
  ...
  // Häufige GeoGuessr-Sondergebiete (kein eigener Staat, aber eigene Coverage):
  "Gibraltar","Grönland","Guam","Guernsey","Hongkong","Isle of Man",
  "Jersey","Puerto Rico","Réunion","Curaçao","Bermuda",
  "Französisch-Guayana","Åland"
];
